const data = {
  ...
  '0/vegetation.bckp': {
    index: '0/vegetation.bckp',
    data: 'vegetation.bckp',
    hasChildren: true,
    children: [
      '0/vegetation.bckp/T',
      '0/vegetation.bckp/qr',
      '0/vegetation.bckp/qs'
    ],
    text: ''
  },
  '0/windward': {
  ...
  'system/air': {
    ...
    children: [
      ...
      'system/air/setFieldsDict',
      'system/air/topoSetDict'
    ],
    text: ''
  },
  'system/leeward': {
  ...
  'system/vegetation': {
    index: 'system/vegetation',
    data: 'vegetation',
    hasChildren: true,
    children: [
      'system/vegetation/changeDictionaryDict',
      'system/vegetation/createPatchDict',
      'system/vegetation/decomposeParDict',
      'system/vegetation/fvSchemes',
      'system/vegetation/fvSolution'
    ],
    text: ''
  },
  'system/windward': {
  ...
  'system/air/setFieldsDict': {
    index: 'system/air/setFieldsDict',
    data: 'setFieldsDict',
    hasChildren: false,
    children: [],
  ...
  'system/vegetation/changeDictionaryDict': {
    index: 'system/vegetation/changeDictionaryDict',
    data: 'changeDictionaryDict',
    hasChildren: false,
    children: [],
  ...
  'system/vegetation/createPatchDict': {
    index: 'system/vegetation/createPatchDict',
    data: 'createPatchDict',
    hasChildren: false,
    children: [],
  ...
  'system/vegetation/decomposeParDict': {
    index: 'system/vegetation/decomposeParDict',
    data: 'decomposeParDict',
    hasChildren: false,
    children: [],
    text: '/*--------------------------------*- C++ -*----------------------------------*\\\n| =========                 |                                                 |\n| \\\\      /  F ield         | OpenFOAM: The Open Source CFD Toolbox           |\n|  \\\\    /   O peration     | Version:  2.0.0                                 |\n|   \\\\  /    A nd           | Web:      www.OpenFOAM.com                      |\n|    \\\\/     M anipulation  |                                                 |\n\\*---------------------------------------------------------------------------*/\nFoamFile\n{\n    version     2.0;\n    format      ascii;\n    class       dictionary;\n    location    "system";\n    object      decomposeParDict;\n}\n// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //\n\nnumberOfSubdomains 48;\n\nmethod          simple;\n\nsimpleCoeffs\n{\n    n               ( 6 1 8 );\n    delta           0.001;\n}\n\nhierarchicalCoeffs\n{\n    n               ( 4 2 2 );\n    delta           0.001;\n    order           xyz;\n}\n\nmanualCoeffs\n{\n    dataFile        "";\n}\n\ndistributed     no;\n\nroots           ( );\n\n\n// ************************************************************************* //\n'
  ...
  'system/vegetation/fvSchemes': {
    index: 'system/vegetation/fvSchemes',
    data: 'fvSchemes',
    hasChildren: false,
    children: [],
  ...
  'system/vegetation/fvSolution': {
    index: 'system/vegetation/fvSolution',
    data: 'fvSolution',
    hasChildren: false,
    children: [],
  ...
  'constant/air': {
    ...
    children: [
      ...
      'constant/air/vegetationProperties'
    ],
    text: ''
  },
  'constant/leeward': {
  ...
  'constant/vegetation': {
    index: 'constant/vegetation',
    data: 'vegetation',
    hasChildren: true,
    children: [
      'constant/vegetation/radiationProperties',
      'constant/vegetation/solarLoadProperties',
      'constant/vegetation/viewFactorsDict'
    ],
    text: ''
  },
  'constant/windward': {
  ...
  'constant/air/vegetationProperties': {
    index: 'constant/air/vegetationProperties',
    data: 'vegetationProperties',
    hasChildren: false,
    children: [],
  ...
  'constant/vegetation/radiationProperties': {
    index: 'constant/vegetation/radiationProperties',
  ...
  'constant/vegetation/solarLoadProperties': {
    index: 'constant/vegetation/solarLoadProperties',
  ...
  'constant/vegetation/viewFactorsDict': {
    index: 'constant/vegetation/viewFactorsDict',
